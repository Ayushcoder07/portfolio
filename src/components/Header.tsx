          ...
          <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            ...
            <SheetContent className="overflow-y-auto">
              <SheetHeader>
                ...
                <SheetDescription>
                 I am a dedicated final-year B.Tech CSE student 🎓 from Graphic Era Hill University, currently working at Infosys and undergoing training for the Digital Specialist Engineer (DSE) role. 💻 Passionate about building scalable and efficient web applications 🌐, I thrive on solving complex problems 🧩 and continuously learning new technologies 📚🚀.
                </SheetDescription>
              </SheetHeader>
