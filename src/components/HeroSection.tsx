...
<span className="text-2xl">🎓</span> from Graphic Era Hill University, currently working at Infosys and undergoing training for the Digital Specialist Engineer (DSE) role.{" "}
<span className="text-xl">💻</span> Passionate about building scalable and efficient web applications{" "}
<span className="text-xl">🌐</span>, I thrive on solving complex problems{" "}
<span className="text-xl">🧩</span> and continuously learning new technologies.{" "}
<span className="text-xl">📚🚀</span>


      </div>
      <div className="flex items-center gap-x-3 ">
        <a href="https://github.com/Ayushcoder07" target="_blank">
